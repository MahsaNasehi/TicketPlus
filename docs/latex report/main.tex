...
\definecolor{reserved}{HTML}{FFF7ED}
\definecolor{reservedborder}{HTML}{C2410C}

\hypersetup{
    colorlinks=true,
    linkcolor=primary,
    urlcolor=accent,
    pdftitle={گزارش طراحی و معماری سامانه تیکت‌پلاس},
    pdfauthor={گروه پروژه مهندسی نرم‌افزار ۲}
}
...
\newcommand{\reservedbox}[2]{%
  \begin{center}
  \fcolorbox{reservedborder}{reserved}{%
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{گزارش طراحی و معماری تیکت‌پلاس}
\fancyhead[L]{مهندسی نرم‌افزار ۲}
\fancyfoot[C]{\thepage}
...
\centering
\vspace*{1.5cm}
{\Large دانشگاه: \underline{\hspace{7cm}}\par}
\vspace{1.2cm}
{\Huge\bfseries طراحی و معماری سامانه جامع فروش بلیت رویداد\par}
\vspace{0.4cm}
{\LARGE\bfseries تیکت‌پلاس\par}
\vspace{0.8cm}
{\Large \term{TicketPlus}\par}
\vspace{1.4cm}
{\Large گزارش نهایی پروژه درس مهندسی نرم‌افزار ۲\par}
\vfill
\begin{tabular}{rl}
استاد درس: & دکتر گوهری\\[0.4em]
نام اعضای گروه: & \underline{\hspace{8cm}}\\[0.4em]
شماره دانشجویی اعضا: & \underline{\hspace{8cm}}\\[0.4em]
نیم‌سال: & بهار ۱۴۰۵\\
\end{tabular}
\vfill
{\large تاریخ تحویل: \underline{\hspace{4cm}}\par}
\end{titlepage}
...
\begin{itemize}[rightmargin=1.2cm]
