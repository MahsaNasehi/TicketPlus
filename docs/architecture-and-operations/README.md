...
|---|---|
| Bounded contexts | [`bounded-contexts.md`](bounded-contexts.md), [`diagrams/bounded-context-map.puml`](diagrams/bounded-context-map.puml) |
| Asynchronous messaging | [`asynchronous-messaging.md`](asynchronous-messaging.md), [`diagrams/async-transaction-flow.puml`](diagrams/async-transaction-flow.puml) |
| Telemetry and monitoring | [`telemetry-and-monitoring.md`](telemetry-and-monitoring.md), [`diagrams/production-telemetry.puml`](diagrams/production-telemetry.puml) |
